      ...
      <div className="w-full max-w-[480px]">
        ...
        <div className="px-4 mb-8">
          ...
          <div className="space-y-4">
            <div className="bg-gradient-to-b from-orange-50 to-orange-100 border border-orange-300 rounded-xl p-6">
              ...
              <p className="text-gray-900 font-bold">Julien, 32 - Actor (Los Angeles, CA)</p>
            </div>
            ...
            <div className="bg-gradient-to-b from-orange-50 to-orange-100 border border-orange-300 rounded-xl p-6">
              ...
              <p className="text-gray-900 font-bold">Sarah, 28 - Teacher (Boston, MA)</p>
            </div>
            ...
            <div className="bg-gradient-to-b from-orange-50 to-orange-100 border border-orange-300 rounded-xl p-6">
              ...
              <p className="text-gray-900 font-bold">Lea, 35 - Startup Founder (Toronto, Canada)</p>
            </div>
            ...
            <div className="bg-gradient-to-b from-orange-50 to-orange-100 border border-orange-300 rounded-xl p-6">
              ...
              <p className="text-gray-900 font-bold">Thomas, 41 - Solo Entrepreneur (Chicago, IL)</p>
            </div>
            ...
            <div className="bg-gradient-to-b from-orange-50 to-orange-100 border border-orange-300 rounded-xl p-6">
              ...
              <p className="text-gray-900 font-bold">Camille, 37 - Coach (Vancouver, Canada)</p>
            </div>
            ...
            <div className="bg-gradient-to-b from-orange-50 to-orange-100 border border-orange-300 rounded-xl p-6">
              ...
              <p className="text-gray-900 font-bold">Adrian, 25 – YouTube Creator (New York, NY)</p>
            </div>
          </div>
        </div>
